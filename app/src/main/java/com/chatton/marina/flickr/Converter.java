...
public class Converter {
    public List<Item> convert(FlickrResponseDto flickrResponseDto){
        List<Item> convertedFlickResponse = new ArrayList<>();
        ...
        for (PhotoDto photoDto : photosDto){
            ...
            convertedFlickResponse.add(new Item(title, url));
        }
